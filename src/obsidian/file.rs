...
pub struct File {
    ...
    pub file_name: String,                   // richard feynman.md
    pub file_name_without_extension: String, // richard feynman

    pub path_from_vault_root: String, // people/richard feynman.md
    pub path_from_vault_root_without_extension: String, // people/richard feynman
